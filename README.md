...
Presentation Layer (Frontend): React SPA running on port 3000.
Application Layer (Backend): Express REST API running on port 5000.
Data Layer (Database): PostgreSQL running on port 5432.
...
2. Start the Application Run the following command in the root directory. This will build the images, start the containers, run migrations, and seed the database.
